...
const Hero = () => (
  <section className='flex justify-center bg-gradient-to-t from-[#fdf3fe] to-white'>
    <div className='text-center my-20 relative' style={{ backgroundImage: "url(https://assets-global.website-files.com/6491847bf90579dea25936ea/6491b337c556a9c134ed403d_Rocket.png)", backgroundPosition: "50% 100%", backgroundSize: "contain", backgroundRepeat: "no-repeat" }}>
      <h2 className="text-4xl px-4 md:px-0 md:text-[5.5rem] leading-none max-w-screen-xl font-extrabold">Turn any <span className="text-[#f65d98]">marketing channel</span> into an <span className="text-[#811bdd]">in-store purchase</span></h2>
      <p className='text-xl md:text-3xl text-gray-500 max-w-screen-lg mt-12 mx-auto'>Unleash the true power of your marketing channels with effortless in-store offers that rockets sales and strengthens brand loyalty</p>
      ...
      <img className="w-52 absolute -bottom-[30%] left-0" src="https://assets-global.website-files.com/6491847bf90579dea25936ea/6491b83d820fab305299c9d3_Emoji-p-500.png"></img>
    </div>
  </section>
);
